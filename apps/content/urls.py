...
urlpatterns = [
    ...
    # API endpoints for expert sheet management
    path('api/categories/', views.get_categories, name='content_api_categories'),
    path('api/sheets/create/', views.create_sheet, name='content_api_create_sheet'),
    path('api/sheets/', views.get_expert_sheets, name='content_api_expert_sheets'),
] 