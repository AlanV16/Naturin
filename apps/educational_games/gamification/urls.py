...
urlpatterns = [
    ...
    path('messaging/conversations/', views.private_conversation_list, name='private_conversation_list'),
    path('messaging/conversation/<int:conversation_id>/', views.private_conversation_detail, name='private_conversation_detail'),
    path('messaging/new/', views.new_private_message, name='new_private_message'),
    path('messaging/search/', views.search_users, name='search_users'),
    path('messaging/classroom/<int:classroom_id>/chat/', views.classroom_chat, name='classroom_chat'),
    path('messaging/notifications/', views.message_notifications, name='message_notifications'),

    # API URLs for real-time updates
    path('messaging/api/unread-count/', views.get_unread_count_api, name='get_unread_count_api'),
    path('messaging/api/conversation/<int:conversation_id>/messages/', views.get_new_messages_api, name='get_new_messages_api'),
]
